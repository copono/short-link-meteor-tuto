...
export default class LinkListItem extends React.Component {
    constructor (props){
        ...
        this.refCopy = React.createRef();
    }

    componentDidMount(){
        this.clipboard = new Clipboard(this.refCopy.current);
        ...
        return (
            <div className="item">
                ...
                <div className="buttoncontainer">
                    ...
                    <button className="button button--pill" ref={this.refCopy} data-clipboard-text={this.props.shortUrl}>
